...
public class Prescription 
{
	...
	@GenericGenerator(name = CustomIdGenerator.GENERATOR_NAME, strategy = "com.revature.model.CustomIdGenerator", parameters = {
	@Parameter(name = CustomIdGenerator.PREFIX_PARAM, value = "PR") })
